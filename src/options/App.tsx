    ...
    <div className="container mx-auto">
      <nav className="flex flex-row justify-between items-center mt-5 px-2">
        <div className="flex flex-row items-center gap-2">
          ...
          <span className="font-semibold">ChatGPT for Upwork bidding (v{getExtensionVersion()})</span>
        </div>
        <div className="flex flex-row gap-3">
          {/* <a href="https://https://github.com/usmansharif525/chatgpt-upwork-extension/changelog" target="_blank" rel="noreferrer">
            Changelog
          </a> */}
          <a
          ...
          <a href="https://twitter.com/ItsUsmanSharif" target="_blank" rel="noreferrer">
            Twitter
          </a>
          <a
